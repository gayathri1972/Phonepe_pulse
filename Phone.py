...
icon = Image.open("D:/images for pro/ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Gayathri Ravi",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Gayathri Ravi*!
...
#Repo.clone_from("https://github.com/gayathri1972/Phonepe_pulse.git", "D:\sample\Phonepe_pulse")
...
# MENU 1 - HOME
if selected == "Home":
    st.image("D:/images for pro/home.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col2:
            ...
            mycursor.execute(f"select state, sum(count) as Total_Transactions, sum(amount) as Total_amount from map_trans where year = {Year} and quarter = {Quarter} group by state order by state")
            df1 = pd.DataFrame(mycursor.fetchall(),columns= ['State', 'Total_Transactions', 'Total_amount'])
            df2 = pd.read_csv('D:/Data/states.csv')
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/gayathri1972/Phonepe_pulse_visualization.git")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("D:/images for pro/Pulseimg.jpg")
